	...
	********************************************/
	$('#fc-agenda-views').fullCalendar({
		...
		events: [
			...
			{
				title: 'Otelo Rodriguez',
                start: '2020-06-09T10:00:00',
                end: '2020-06-09T10:30:00',
                //url: '/Cita/AtencionVirtual'
			},
            {
                title: 'Renzo Rodriguez',
                start: '2020-06-11T10:00:00',
                end: '2020-06-11T10:30:00',
                //url: '/Cita/AtencionVirtual'
            },
			{
				title: 'Meeting',
				start: '2020-06-02T14:30:00'
			},
			{
				title: 'Happy Hour',
				start: '2016-06-12T17:30:00'
        ...
        eventClick: function (event) {
            if (event.title == 'Otelo Rodriguez') {
                $("#modalCitaVer").modal('show');
            } else {
                $("#modalCitaAtencion").modal('show');
            }
        }
	});
