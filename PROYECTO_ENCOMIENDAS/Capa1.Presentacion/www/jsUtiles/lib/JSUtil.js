...
(function ($) {
    $.Util = {
        ...
        devuelvefechajson: function (_fecha) {
            var fecha = "";
            if (_fecha != null) {
    ...
    Jdevuelvefechajson = function (_fecha) { return $.Util.devuelvefechajson(_fecha); };
...
(function ($) {
    ...
    $.fn.jstableServer = function (_setting) {
        var table = this;
        var configuracion = {};
        var settings = $.extend({
            pageLength: 10,
        ...
        if (!settings.ordering) {
            ...
            if (settings.order.length > 0) {
                configuracion.order = settings.order;
            }
        }
            ...
            configuracion.ajax = {
                ...
                "data": function (d) {
                    ...
                    if (settings.prmentrada != "") {
                        ...
                        if (settings.prmentrada.IdFiltro !== undefined) {
                            // console.log("X");
                            entrada.prm_tabla.IdFiltro = settings.prmentrada.IdFiltro;
                        }

                        return JSON.stringify(entrada.prm_tabla);
                    } else {
